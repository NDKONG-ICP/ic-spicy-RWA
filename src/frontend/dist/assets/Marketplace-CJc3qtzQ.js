import { d as createLucideIcon, r as reactExports, o as useProducts, p as useProductsByCategory, q as useHasMembership, s as useTokenPrices, t as useMembershipPrices, j as jsxRuntimeExports, F as Flame, m as motion, B as Badge, v as ProductCategory, a as Button, w as useAuth, x as useGetMyOffers, y as useGetOffersReceived, z as useGetActiveResaleListings, D as useIssueMembership, O as OFFER_TOKENS, T as TOKEN_DISPLAY, E as useCart, G as ShoppingCart, A as AnimatePresence, X, H as useCancelOffer, I as useAcceptOffer, J as OfferStatus, K as useRejectOffer, N as useBuyResaleListing, R as RarityTier, Q as TOKEN_DECIMALS, U as NFTStandard, V as MembershipTier, f as ue, W as useCounterOffer, Y as useSubmitOffer } from "./index-LPJkeeMn.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-Dxe68on8.js";
...
import { A as ArrowLeftRight } from "./arrow-left-right-CSH7llby.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video rounded-lg bg-secondary flex items-center justify-center text-6xl mb-4", children: getProductEmoji(product.category) }),
