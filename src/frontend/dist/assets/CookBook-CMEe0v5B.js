import { e as useListRecipes, r as reactExports, j as jsxRuntimeExports, m as motion, B as Badge, X, a as Button, A as AnimatePresence, f as ue } from "./index-LPJkeeMn.js";
...
import { S as Search } from "./search-Bc2hKy9m.js";
import { B as BookOpen } from "./book-open-CJPW2aE1.js";
import { E as ExternalLink } from "./external-link-DyW81ppu.js";
import { S as Star } from "./star-ayZEfesG.js";
import { P as Printer } from "./printer-DqOFbLyd.js";
...
const KNF_FALLBACK = [
  {
    ...
    description: "A fermented herbal elixir made from five medicinal plants. OHN revitalizes crops, boosts immunity, promotes robustness, and acts as a natural biostimulant. One of the most essential KNF inputs.",
    ingredients: [
    ...
    application_notes: "Dilute 1:500–1:1000 in water. Apply as foliar spray, soil drench, or seed soak. Use throughout all growth stages weekly. Combine with FPJ at 500:1 for weak plants. For disease (soft rot, anthracnose), add WCA at 1:1000. Promotes plant heat retention, sterilizes, and revitalizes crops.",
    tags: ["KNF", "herbal", "immune-boost", "foliar", "soil-drench", "ferment"],
    is_featured: true,
    photo_key: void 0,
    shop_link: void 0,
    shop_link_label: void 0
  },
  {
    name: "FPJ",
    full_name: "Fermented Plant Juice",
    description: "A concentrated liquid ferment of fast-growing plant meristems. FPJ captures the vital growth energy of actively growing plant tissue, delivering growth hormones, enzymes, and beneficial microorganisms directly to your crops.",
    ingredients: [
    ...
    application_notes: "Dilute 1:500–1:1000 for foliar spray. Apply during vegetative and fruiting stages. Combine with OHN and WCA for a full KNF formula. Always taste and smell before use. A good FPJ smells sweet and fermented, not rotten.",
  ...
  },
  {
    ...
    description: "Similar to FPJ but uses the whole above-ground plant rather than just meristems. FPE provides a broader nutrient spectrum including potassium, phosphorus, and trace minerals. Excellent for general fertility and crop health.",
    ingredients: [
    ...
    application_notes: "Apply at 1:500 as foliar spray or soil drench. Particularly valuable for fruiting and flowering crops. Rich in potassium and phosphorus for brix development. Can be combined with OHN and FPJ for a complete KNF cocktail.",
  ...
  },
  {
    ...
    description: "Produced by dissolving eggshells or clamshells in raw apple cider vinegar. WCA delivers bioavailable calcium that regulates cell wall structure, reduces blossom end rot, firms up soft tissues, and acts as a natural fungicide.",
    ingredients: [
    ...
    application_notes: "Dilute 1:1000 in water for foliar spray or soil drench. Apply during fruiting stage to firm up produce and prevent blossom end rot. For fungal diseases (powdery mildew, downy mildew): combine WCA at 1:1000 with OHN at 1:1000 for a powerful natural fungicide spray.",
  ...
  },
  {
    ...
    description: "IMO2 is the second stage of the Indigenous Microorganisms process. Wild IMO1 culture collected from your forest floor is mixed with rice bran and brown sugar to create a large, active microbial colony rich in beneficial bacteria, fungi, and yeasts native to your specific ecosystem.",
    ingredients: [
    ...
    application_notes: "IMO2 is mixed with soil amendments to create IMO3 and IMO4 or applied directly to soil at 100–500g per square meter. The indigenous microorganisms decompose organic matter, fix nitrogen, and build soil ecosystem health specific to your local environment.",
  ...
  },
  {
    ...
    description: "LAB serum is a concentrated culture of lactic acid bacteria harvested from the ambient environment using rice wash water and milk. LAB decomposes organic matter, suppresses harmful pathogens, builds beneficial microbial populations, and improves soil and plant health.",
    ingredients: [
    ...
    application_notes: "Dilute 1:1000 for foliar spray or soil drench. The LAB serum can also be added to animal feed, compost piles, or EM (effective microorganism) blends. Particularly effective for breaking down organic matter quickly and suppressing pathogenic fungi. Safe to apply frequently.",
    tags: [
      "KNF",
      "LAB",
      "bacteria",
  ...
  },
  {
    ...
    description: "AEM (Activated EM) is an expanded, ready-to-use version of EM1 (commercial Effective Microorganism concentrate). Activation multiplies the microbial culture, making it more potent and cost-effective for large-scale farm application.",
    ingredients: [
    ...
    application_notes: "Dilute 1:1000 for foliar spray. Dilute 1:500 for soil drench and compost activation. Apply weekly during crop production. AEM accelerates organic matter decomposition, suppresses pathogens, and promotes plant growth. Can be used to activate compost, treat waste, and clean farm equipment.",
    tags: [
      "KNF",
      "EM",
  ...
  },
  {
    ...
    description: "Fermented Fruit Acid is made by fermenting fresh citrus or other acidic fruits to produce a complex blend of organic acids, sugars, enzymes, and beneficial microorganisms. FFA supports fruiting, enhances brix (sugar content), and improves flavor in harvested crops.",
    ingredients: [
    ...
    application_notes: "Dilute 1:500–1:1000 for foliar spray during fruiting and finishing stages. FFA enhances brix, improves flavor, and provides organic acids that regulate soil pH. Combine with WCA at transition to fruiting for robust cell structure and flavor development. Do not apply during the vegetative growth stage.",
...
function getTagClass(tag) {
  return TAG_COLORS[tag] ?? "bg-muted/50 text-muted-foreground border-border/50";
}
function RecipeCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recipe-card space-y-4", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: "Natural Farming CookBook"
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { paddingLeft: "16px", margin: 0 }, children: recipe.ingredients.map((ing) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "li",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { style: { paddingLeft: "16px", margin: 0 }, children: recipe.instructions.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "li",
                  {
                    style: {
                      fontSize: "11px",
        ...
        recipe.application_notes && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              marginTop: "20px",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: recipe.application_notes
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: recipe.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  fontSize: "9px",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    ...
                    " IC SPICY Nursery · icspicy.farm · Natural Farming Inputs"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function Accordion({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/50 pt-3 mt-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        "aria-expanded": open,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "recipe-section-title group-hover:text-primary transition-colors", children: title }),
...
function RecipeCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      children: [
        recipe.is_featured && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 flex items-center gap-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-2 py-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3 text-yellow-400 fill-yellow-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold text-yellow-400 uppercase tracking-wider", children: "Featured" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl bg-primary/10 border border-primary/20 flex-shrink-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl text-primary leading-none", children: recipe.name.slice(0, 3) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "recipe-title", children: recipe.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "recipe-subtitle", children: recipe.full_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-2", children: recipe.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-2", children: recipe.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Accordion,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: recipe.ingredients.map((ing) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "recipe-ingredient flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "recipe-ingredient-highlight flex-shrink-0 select-none", children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ing })
            ] }, ing.slice(0, 40))) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Accordion,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2 list-none", children: recipe.instructions.map((step, stepIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "recipe-step flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "recipe-ingredient-highlight font-bold text-sm w-5 flex-shrink-0 text-right", children: [
                stepIdx + 1,
                "."
              ] }),
        ...
        recipe.application_notes && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Accordion,
          {
            title: "Application Notes",
            defaultOpen: false,
            ocid: `recipe-notes-toggle-${recipe.name.toLowerCase()}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/5 border border-primary/15 rounded-lg p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: recipe.application_notes }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mt-5 pt-4 border-t border-border/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3.5 h-3.5 text-chart-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-3.5 h-3.5" }),
                copied ? "Copied!" : "Share"
              ]
            }
          ),
          recipe.shop_link && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(PrintCard, { recipe })
      ]
    }
  );
}
...
function CookBookPage() {
  ...
  const [activeTags, setActiveTags] = reactExports.useState(/* @__PURE__ */ new Set());
  const [activePrintId, setActivePrintId] = reactExports.useState(null);
  const searchRef = reactExports.useRef(null);
  const allRecipes = backendRecipes && backendRecipes.length > 0 ? backendRecipes : KNF_FALLBACK.map((r, i) => ({
    ...r,
    id: BigInt(i),
    created_at: BigInt(0),
    updated_at: BigInt(0)
  ...
  const filteredRecipes = allRecipes.filter((recipe) => {
    ...
    const matchesSearch = !q || recipe.name.toLowerCase().includes(q) || recipe.full_name.toLowerCase().includes(q) || recipe.description.toLowerCase().includes(q) || recipe.tags.some((t) => t.toLowerCase().includes(q));
    const matchesTags = activeTags.size === 0 || recipe.tags.some((t) => activeTags.has(t));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 pb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col justify-center px-8 sm:px-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest text-primary", children: "Natural Farming" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-3xl sm:text-5xl text-foreground leading-none mb-3", children: [
                "IC SPICY ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-fire", children: "CookBook" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base text-muted-foreground max-w-lg leading-relaxed", children: "Time-tested KNF inputs from our regenerative farm kitchen — organically sourced, beautifully documented, ready to print and take to the greenhouse." }),
      ...
      !isLoading && featuredRecipes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          className: "mb-12",
          initial: { opacity: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-lg text-foreground", children: "Featured Recipes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border/40 ml-2" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: featuredRecipes.map((recipe, i) => {
              var _a;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                "id" in recipe ? ((_a = recipe.id) == null ? void 0 : _a.toString()) ?? recipe.name : recipe.name
              );
            }) })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
                ...
                children: [
                  allTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: `text-xs px-3 py-1.5 rounded-full border font-medium transition-smooth ${activeTags.has(tag) ? "bg-primary text-primary-foreground border-primary" : "bg-muted/30 text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"}`,
                  ...
                  activeTags.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      onClick: () => setActiveTags(/* @__PURE__ */ new Set()),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-label": "All recipes", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-lg text-foreground", children: search || activeTags.size > 0 ? "Search Results" : "All Recipes" }),
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["sk1", "sk2", "sk3", "sk4", "sk5", "sk6"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(RecipeCardSkeleton, {}, k))
          }
        ) : filteredRecipes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted/30 border border-border flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-7 h-7 text-muted-foreground/50" }) }),
              search || activeTags.size > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium mb-2", children: "No recipes match your search" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Try a different search term or clear your filters." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    size: "sm",
                    ...
                    onClick: () => {
                      setSearch("");
                      setActiveTags(/* @__PURE__ */ new Set());
                    },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium mb-2", children: "No recipes yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Check back soon — new KNF recipes are being added." })
              ] })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5", children: filteredRecipes.map((recipe, i) => {
          var _a;
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            RecipeCard,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-8 h-8 text-primary mx-auto mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-2", children: "Source Your KNF Inputs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-md mx-auto mb-5", children: "We carry curated Garden Inputs — herbs, sugars, and materials for making your own natural farming ferments, all organically sourced." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/marketplace?category=GardenInputs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
