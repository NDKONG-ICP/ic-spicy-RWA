import { d as createLucideIcon, aa as useQuery, ab as useActor, ac as useQueryClient, ad as useMutation, ae as createActor, o as useAuth, r as reactExports, K as useTokenPrices, j as jsxRuntimeExports, F as Flame, a as Button, m as motion, f as ue, t as useMyPlants, B as Badge, R as RarityTier, L as Link, am as TxType, an as TxStatus } from "./index-BzyHOfJH.js";
import { C as Card, b as CardContent, a as CardHeader, d as CardTitle } from "./card-CRAqL66D.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, h as DialogFooter } from "./dialog-Cx326vb4.js";
...
function WalletPage() {
  ...
  const [walletIdCopied, setWalletIdCopied] = reactExports.useState(false);
  ...
  const principalId = (principal == null ? void 0 : principal.toText()) ?? "";
  ...
  function copyPrincipalId() {
    ...
    navigator.clipboard.writeText(principalId).then(() => {
      ...
      ue.success("Wallet ID copied to clipboard!");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        principalId && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-yellow-400 uppercase tracking-wider mb-1", children: "Your Internet Identity Principal ID" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-yellow-300/70 mb-2", children: 'Copy this and compare it to the admin list if the Admin panel shows "Access Restricted"' }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: walletIdCopied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 text-emerald-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-400", children: "Copied!" })
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-3.5 h-3.5" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Copy ID" })
                  ] })
                }
              )
            ] })
        ...
        principalId && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-card border-border", "data-ocid": "wallet-id-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "w-4 h-4 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-tight", children: "Your Wallet ID" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Internet Identity principal · on-chain identity" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-[11px] text-muted-foreground", children: "This is your unique on-chain identity. Share it to receive NFTs or be identified in the IC ecosystem." })
            ] }) })
          }
        ),
